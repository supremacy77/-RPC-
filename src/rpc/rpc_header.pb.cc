...
const uint32_t TableStruct_rpc_5fheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::rpc::RpcRequest, _impl_.args_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_rpc_5fheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020rpc_header.proto\022\003rpc\"E\n\nRpcRequest\022\024\n"
  "\014service_name\030\001 \001(\t\022\023\n\013method_name\030\002 \001(\t"
  "\022\014\n\004args\030\003 \001(\014\"\325\001\n\013RpcResponse\022.\n\nerror_"
  "code\030\001 \001(\0162\032.rpc.RpcResponse.ErrorCode\022\021"
  "\n\terror_msg\030\002 \001(\t\022\016\n\006result\030\003 \001(\014\"s\n\tErr"
  "orCode\022\014\n\010NO_ERROR\020\000\022\017\n\013WRONG_PROTO\020\001\022\016\n"
  "\nNO_SERVICE\020\002\022\r\n\tNO_METHOD\020\003\022\024\n\020INVALID_"
  "ARGUMENT\020\004\022\022\n\016INTERNAL_ERROR\020\005b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_rpc_5fheader_2eproto = {
    false, false, 318, descriptor_table_protodef_rpc_5fheader_2eproto,
    "rpc_header.proto",
...
constexpr RpcResponse_ErrorCode RpcResponse::NO_ERROR;
constexpr RpcResponse_ErrorCode RpcResponse::WRONG_PROTO;
constexpr RpcResponse_ErrorCode RpcResponse::NO_SERVICE;
constexpr RpcResponse_ErrorCode RpcResponse::NO_METHOD;
constexpr RpcResponse_ErrorCode RpcResponse::INVALID_ARGUMENT;
constexpr RpcResponse_ErrorCode RpcResponse::INTERNAL_ERROR;
constexpr RpcResponse_ErrorCode RpcResponse::ErrorCode_MIN;
constexpr RpcResponse_ErrorCode RpcResponse::ErrorCode_MAX;
constexpr int RpcResponse::ErrorCode_ARRAYSIZE;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          CHK_(ptr);
          _internal_set_error_code(static_cast<::rpc::RpcResponse_ErrorCode>(val));
        } else
          goto handle_unusual;
        continue;
      // string error_msg = 2;
